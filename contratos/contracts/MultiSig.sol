...
contract SimpleMultiSig {
    ...
    uint256 public _requiredConfirmations;
        ...
        notExecuted(txnId_)
    {
        ...
        if (confirmations(txnId_) >= _requiredConfirmations) {
            executeTransaction(txnId_);
        }
    }
    ...
    function confirmations(uint256 txnId_) public view returns (uint256) {
        uint256 confirmations_ = 0;
